                    ...
                    <ol class="inline-flex items-center lg:space-x-2 rtl:space-x-reverse">
                        <li class="inline-flex items-center">
                            <a href="{{ url('/') }}"
                                ...
                                <svg class="w-2 h-2 lg:w-4 lg:h-4 me-1 lg:me-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li>
                            <div class="flex items-center">
                                <svg class="rtl:rotate-180 w-2 h-2 lg:w-4 lg:h-4 text-gray-400 mx-0.5 lg:mx-1" aria-hidden="true"
                    ...
                    <div class="w-full flex flex-col gap-1 lg:gap-2">
                        ...
                        <div class=" text-xs lg:text-base text-gray-500">
                            <ol class="list-inside list-decimal">
                                <li>Memberikan Pelayanan kesehatan secara profesional, efisien dan efektif yang berorientasi kepada
                                    pelanggan, tanpa membeda-bedakan asal-usul dan kondisi finansial pasien mampu atau tidak mampu,
                                    pasien dengan jaminan atau tanpa jaminan.</li><br>
                                <li>Menyelenggarakan manajemen rumah sakit dengan kaidah bisnis yang sehat, terbuka, efisien, efektif,
                                    dan akuntabel guna meningkatkan derajat kesehatan masyarakat umum serta kesejahteraan karyawan.</li><br>
                                <li>Mengelola rumah sakit, poliklinik dan fasilitas kesehatan lainnya senantiasa mengutamakan kepentingan
                                ...
                                <li>Penambahan investasi sarana dan prasarana layanan kesehatan sebagai
                                    salah satu unsur penting ujung tombak dalam memberikan pelayanan kesehatan yang terbaik bagi masyarakat
                                    Kota Baubau dan sekitarnya</li><br>
                                <li>Terjalinnya kerjasama yang saling menguntungkan dengan organisasi profesi terkait dengan bidang kesehatan</li><br>
                            </ol>
                        </div>
                        <div class="flex gap-2 text-xs lg:text-sm text-gray-500">
                        </div>
            ...
            <div class="shadow">
                <div class="h-48 overflow-hidden rounded relative">
                    <img src="{{ asset('asset/image/unggulan/mobil-donor-darah.jpg') }}" alt=""
                        class="object-cove w-full">
                    <div
                        class="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-t from-gray-900 to-transparent flex flex-col justify-end p-4 ">
                        <h4 class="text-2xl text-white font-bold">Kunjungi Profil RSUD Kota Baubau</h4>
            ...
            <div class="mt-8">
                ...
                <div class="p-4 flex flex-col gap-3">
                    <div class="flex gap-4">
                        <img src="{{ asset('asset/image/dokter-spesialis/avatar.png') }}" alt=""
                            class="h-14 w-14 object-cover object-center rounded-full shadow-sm">
                        <div>
                            <b><a href="">Judul berita 1</a></b>
                            <p class="text-sm line-clamp-1">Detail Berita rumah sakit daerah kota baubau provinsi sulawesi tenggara</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <img src="{{ asset('asset/image/dokter-spesialis/avatar.png') }}" alt=""
