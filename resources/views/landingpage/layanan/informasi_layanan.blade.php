...
@section('views')
    <section class="min-h-screen">
        ...
        <section class="flex flex-col w-full gap-5 p-2 md:flex-row lg:p-10">
            <div id="accordion-collapse" data-accordion="collapse" class="mb-10">
                <p class="ml-2 text-gray-500 dark:text-gray-400">Deliver great service experiences fast - without the
                    complexity
                ...
                <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                        <p class="mb-2 text-sm font-semibold text-gray-500 dark:text-gray-400">INSTALASI GAWAT DARURAT.</p>
                ...
                <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
                    <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                        ...
                        <p>4 Tempat Tidur</p>
                        <p>Paviliun terdiri dari kamar pasien, ruang keluarga, pantry, AC, Kamar mandi pasien, kamar mandi
                        ...
                        <p>40 Tempat Tidur</p>
                        <p>1 tempat tidur dalam satu ruangan, AC, Kamar mandi dalam, tempat tidur, Sofa bed, kursi tamu,
                            pesawat televisi, refrigerator.</p>
                        <h6>Ruangan Kelas I : Gedung Laika Mendidoha Lt. 1</h6>
                        <p>56 Tempat Tidur</p>
                        <p>Terdiri dari 2 tempat tidur dalam satu ruangan, AC, kamar mandi dalam, pesawat televisi</p>
                        <h6>Ruangan Kelas I : Gedung Lambu Barakati Lt. 1</h6>
                        <p>34 Tempat Tidur</p>
                        <p>Terdiri dari 2 tempat tidur dalam satu ruangan, AC, kamar mandi dalam, pesawat televisi</p>
                        <h6>Ruangan Kelas II : Gedung Raha Mongkilo</h6>
                        <p>37 Tempat Tidur</p>
                        <p>Terdiri dari 3 &#8211; 4 Tempat tidur dalam satu ruangan, Exhaust fan, kamar mandi dalam.</p>
                        <h6>Ruangan Kelas III Bedah : Gedung Laika Waraka Lt. 1</h6>
                        <p>50 Tempat Tidur</p>
                        <p>Terdiri dari 4 &#8211; 6 Tempat Tidur dalam satu ruangan, Exhaust fan, kamar mandi dalam.</p>
            ...
            <div class="w-full md:w-[45%] lg:w-[35%]">
