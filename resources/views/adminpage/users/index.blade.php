    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
            <div class="flex flex-col gap-4">
                <h5 class="text-2xl font-semibold capitalize">Daftar Akun</h5>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-500 ms-1 md:ms-2 dark:text-gray-400">Akun</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <div class="relative overflow-x-auto rounded shadow sm:rounded-lg">
            <table id="table"
                class="table w-full text-sm text-left text-gray-500 display rtl:text-right dark:text-gray-400"
                style="width:100%">
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                @if ($row->is_superadmin)
                                    <span class="p-1 text-white rounded bg-primary-700">Superadmin</span>
                                @else
                                    <span class="p-1 text-white rounded bg-secondary-600">Admin</span>
                                @endif
                            </td>
                            <td class="px-6 py-4">
                                ...
                                <form action="{{ route('users.destroy', $row->id) }}" class="inline-block"
                                    method="post">
                                    @csrf
                                    @method('delete')
                                    <button type="submit"
                                        onclick="return confirm('Yakin ingin menghapus akun {{ $row->username }}?')"
