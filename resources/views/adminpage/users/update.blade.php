...
@section('konten')
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="relative">
            <form action="{{ route('users.update', $user->id) }}" class="p-1 rounded shadow sm:rounded-lg md:p-4"
                method="POST">
                @csrf
                @method('put')
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="nama_lengkap" name="nama_lengkap"
                            class="input @error('nama_lengkap')
                                is-invalid
                            @enderror"
                            placeholder="nama lengkap" required value="{{ old('nama_lengkap', $user->nama) }}">
                        @error('nama_lengkap')
                    ...
                    <div class="input-group">
                        ...
                        <div class="grid w-full grid-cols-2 gap-2">
                            <div
                                ...
                                <input @checked(!$user->is_superadmin) id="admin" type="radio" value="0"
                                    name="role"
                            ...
                            <div
                                class="flex items-center border border-gray-200 rounded cursor-pointer ps-4 dark:border-gray-700">
                                <input @checked($user->is_superadmin) id="superadmin" type="radio" value="1"
                                    name="role"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 cursor-pointer focus:ring-blue-500 focus:ring-2">
