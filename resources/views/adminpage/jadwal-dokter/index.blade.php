    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
            <div class="flex flex-col gap-4">
                <h5 class="text-2xl font-semibold capitalize">Daftar Jadwal Dokter</h5>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-500 ms-1 md:ms-2 dark:text-gray-400">Jadwal
                                    Dokter</span>
                            </div>
                        </li>
                    </ol>
            ...
            <div class="flex items-end">
                <a href="{{ route('jadwal-dokter.create') }}" type="button"
                    ...
                    @foreach ($data as $row)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                ...
                                {{-- <form action="{{ route('jadwal-dokter.destroy', $row->id) }}" class="inline-block"
                                    method="post">
                                    @csrf
                                    @method('delete')
                                    <button type="submit"
