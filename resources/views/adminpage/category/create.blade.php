    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
            <div class="flex flex-col gap-4">
                <h5 class="text-2xl font-semibold capitalize">Tambah Kategori</h5>
        ...
        <div class="relative">
            <form action="{{ route('categories.store') }}" class="p-1 rounded shadow sm:rounded-lg md:p-4" method="POST">
                @csrf
                @method('POST')
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="kategori" name="kategori"
                            ...
                            @enderror"
                            placeholder="kegiatan" required value="{{ old('kategori') }}">
                        @error('kategori')
