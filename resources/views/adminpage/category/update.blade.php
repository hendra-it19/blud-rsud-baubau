    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
            <div class="flex flex-col gap-4">
                <h5 class="text-2xl font-semibold capitalize">Update Kategori</h5>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <a href="{{ route('categories.index') }}" class="flex items-center">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-700 hover:text-primary-700 ms-1 md:ms-2">Kategori</span>
                            </a>
                        </li>
        ...
        <div class="relative">
            <form action="{{ route('categories.update', $category->id) }}" class="p-1 rounded shadow sm:rounded-lg md:p-4"
                method="POST">
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="kategori" name="kategori"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 @error('kategori')
                                border-red-300 focus:ring-red-500 focus:border-red-500 text-red-500
                            @enderror"
                            placeholder="kegiatan" required value="{{ old('kategori', $category->nama_kategori) }}">
                        @error('kategori')
