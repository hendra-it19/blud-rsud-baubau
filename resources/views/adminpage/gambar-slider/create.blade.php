    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <form action="{{ route('gambar-slider.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('post')

                    <div class="mb-3 border-4 rounded-md w-72 h-36 bg-cover object-cover">
                        <img src="https://placehold.co/1080x1080?text=slider" alt="" id="preview-selected-image"
