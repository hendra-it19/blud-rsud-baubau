    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span
                                    class="text-sm font-medium text-gray-500 ms-1 md:ms-2 dark:text-gray-400">E-Berkas</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="flex items-end">
                <a href="{{ route('anjab.create') }}" type="button"
                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="{{ asset($row->file) }}" download
                                    class="py-1 px-3 rounded shadow-sm bg-primary-600 text-white hover:bg-primary-800">Download
                                    Berkas</a>
                            </td>
                            <td class="px-6 py-4">
                                <a href="{{ route('anjab.edit', $row->id) }}"
                                ...
                                <form action="{{ route('anjab.destroy', $row->id) }}" class="inline-block" method="post">
                                    @csrf
                                    @method('delete')
                                    <button type="submit"
                                        onclick="return confirm('Yakin ingin menghapus berkas {{ $row->nama_berkas }}?')"
