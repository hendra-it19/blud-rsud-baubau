    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
            <div class="flex flex-col gap-4">
                <h5 class="text-2xl font-semibold capitalize">Update Dokter</h5>
        ...
        <div class="relative">
            <form action="{{ route('dokter.update', $dokter->id) }}" class="p-1 rounded shadow sm:rounded-lg md:p-4"
                method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')

                <div class="mb-3 border-4 rounded-md w-36 h-36">
                    <img src="{{ asset($dokter->foto) }}" alt="" id="preview-selected-image"
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="poliklinik" name="poliklinik"
                            class="input @error('poliklinik')
                                is-invalid
                            @enderror"
                            required value="{{ old('poliklinik', $dokter->poliklinik) }}">
                        @error('poliklinik')
                            <small class="text-red-500">
                                {{ $message }}
                            </small>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="nomor_hp" name="nomor_hp"
                            class="input @error('nomor_hp')
                                is-invalid
                            @enderror"
                            required value="{{ old('nomor_hp', $dokter->no_hp) }}">
                        @error('nomor_hp')
                            <small class="text-red-500">
                                {{ $message }}
                            </small>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="nomor_sip" name="nomor_sip"
                            class="input @error('nomor_sip')
                                is-invalid
                            @enderror"
                            required value="{{ old('nomor_sip', $dokter->no_sip) }}">
                        @error('nomor_sip')
                            <small class="text-red-500">
                                {{ $message }}
                            </small>
