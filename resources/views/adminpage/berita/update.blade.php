    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
            <div class="flex flex-col gap-4">
                <h5 class="text-2xl font-semibold capitalize">Update Berita</h5>
        ...
        <div class="relative">
            <form action="{{ route('berita.update', $postinganBerita->id) }}"
                    ...
                    <div class="input-group">
                        <label for="foto"
                            class="relative cursor-pointer w-[250px] h-[250px] overflow-hidden rounded-md block @error('foto')
                                is-invalid border-2
                            @enderror">
                            <img src="{{ asset($postinganBerita->foto) }}" alt="berita" id="preview-selected-image"
                                class="z-10 object-cover w-full obsolute">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="judul" name="judul"
                            class="input @error('judul')
                                is-invalid
                            @enderror"
                            placeholder="kegiatan" required value="{{ old('judul', $postinganBerita->judul) }}">
                        @error('judul')
                            <small class="text-red-500">
                                {{ $message }}
                            </small>
                    ...
                    <div class="input-group">
                        ...
                        @enderror">
                            ...
                            @foreach ($kategori as $row)
                                <option value="{{ $row->id }}" @if ($row->id == old('kategori', $postinganBerita->category_id)) selected @endif>
                ...
                <div class="w-full">
                    ...
                    <input type="hidden" name="isi_berita" id="isi_berita"
                        value="{{ old('isi_berita', $postinganBerita->konten) }}">
