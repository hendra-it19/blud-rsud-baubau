    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
            <div class="flex flex-col gap-4">
                <h5 class="text-2xl font-semibold capitalize">Ganti Gambar Hero Section</h5>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-500 ms-1 md:ms-2 dark:text-gray-400">Hero
                                    Section</span>
                            </div>
                        </li>
                    </ol>
            ...
            <div class="flex items-end">
                ...
                <button data-modal-target="modal-create" data-modal-toggle="modal-create"
                    ...
                    {{ $status ? 'Perbarui Gambar' : 'Upload Gambar' }}
                </button>
                @include('adminpage.gambar-tema.create')
            </div>
        </div>
