    ...
    <div class="p-4 sm:ml-64 lg:p-10">
        ...
        <div class="flex justify-between gap-5 mb-7 lg:mb-12">
            <div class="flex flex-col gap-4">
                <h5 class="text-2xl font-semibold capitalize">Tambah Struktural</h5>
        ...
        <div class="relative">
            <form action="{{ route('strukturals.store') }}" class="p-1 rounded shadow sm:rounded-lg md:p-4" method="POST"
                    ...
                    <div class="input-group">
                        ...
                        <textarea type="text" id="profil" name="profil" rows="7"
                            class="input h-auto @error('profil')
                                is-invalid
                            @enderror"
                            placeholder="Profil Singkat">{{ old('profil') }}</textarea>
                        @error('profil')
                            <small class="text-red-500">
                                {{ $message }}
                            </small>
